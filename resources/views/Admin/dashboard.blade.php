        ...
        <nav class="navbar navbar-expand-sm">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav navbar-center ml-auto ">
                    ...
                    <li class="navbar-item">
                        <i class="bi bi-bag-plus">Agregar</i>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div id="content">
        <nav id="siderbar">
            <div class="siderbar-header">
                ...
                @if(auth()->check())
                @endif --}}
                <img id="logo-perfil" src="{{url('https://media.revistagq.com/photos/5fc4d3e608c92a6bb64b9b83/1:1/w_960,c_limit/baby-yoda-nombre.jpg')}}" class="img-fluid rounded-circle shadow-lg"> 
            </div>
        </nav>
        <ul class="list">
            <li>
